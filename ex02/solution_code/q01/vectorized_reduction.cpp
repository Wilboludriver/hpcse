...
///////////////////////////////////////////////////////////////////////////////
// Partially complete. Your task is to write the missing code
///////////////////////////////////////////////////////////////////////////////
/**
...
{
    // just a check to test if the vector registers fit nicely into all
    // elements N.  This is to make matters simple for this exercise, we want
    // to focus on vectorization and not how to deal with remainder data (in
    // real life you will likely have to deal with it)
    ...
    // badly with gcc:
    // union { __m128 sum4; float last[4]; };
...
int main(void)
{
    constexpr size_t N0 = (1<<15); // fits in cache
    constexpr size_t N1 = (1<<20); // memory bound
